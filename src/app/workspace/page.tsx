...
export default function Page() {
  ...
  // Check if we have a workspace query param - if so, redirect to path-based URL
  const workspaceQueryParam = searchParams.get('workspace')
  
  useEffect(() => {
    if (workspaceQueryParam) {
      console.log('[Dashboard] Redirecting to path-based workspace URL')
      router.replace(`/dashboard/workspace/${workspaceQueryParam}`)
      return
    }
  }, [workspaceQueryParam, router])
